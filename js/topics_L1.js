...
const TOPICS_L1 = [
  {
    ...
    beginner:{
      ...
      example:{
        sector:'res',
        given:'A 230V single-phase circuit feeds a 2.3kW water heater. Find current and resistance.',
        steps:[
      ...
      rot:["Rule of thumb: For 230V single-phase loads, divide watts by 230 to get amps. A 1kW load ≈ 4.35A, a 2kW load ≈ 8.7A, a 3kW load ≈ 13A."],
    ...
    calculator:null,
    sectorNotes:{
      res:'In residential wiring, Ohm\'s Law is applied to size DB circuits. Each 20A breaker at 230V can supply a maximum of 4.6kW (20 × 230). Typical loop impedance limit: Zs ≤ 1.09Ω for 32A Type B MCB.',
...

  {
    ...
    calculator:null,
    sectorNotes:{
      res:'Residential supply: 230V AC single-phase (phase to neutral). Heavy loads (EV chargers, HVAC) may use 3-phase 415V. All battery systems (UPS, solar storage) involve AC↔DC conversion.',
...

  {
    ...
    beginner:{
      ...
      interviewQs:["Why is the line voltage 415V in India but only 230V appears on a socket outlet?","In a delta connection, if one fuse blows in one phase, what happens to the other two phases?","Why do motors sometimes have 6 terminals marked U1,U2,V1,V2,W1,W2?"],
