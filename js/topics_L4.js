...
const TOPICS_L4 = [
  ...
  /* ── 4. HAZARDOUS AREA ── */
  {
    ...
    beginner:{
      ...
      theory:"ZONE CLASSIFICATION (IEC 60079-10 / IS 5572):\nZone 0: explosive atmosphere present continuously or for long periods (inside tanks, pipes)\nZone 1: explosive atmosphere likely to occur in normal operation (pump seals, valve glands)\nZone 2: explosive atmosphere not likely in normal operation, but may occur briefly (bund areas, drainage)\n\nGAS GROUPS (equipment temperature class based on ignition energy):\nGroup IIA: propane and similar — least sensitive\nGroup IIB: ethylene — more sensitive\nGroup IIC: hydrogen, acetylene — most sensitive (requires highest protection)\n\nTEMPERATURE CLASS (maximum surface temperature of equipment):\nT1: ≤450°C — gases with autoignition >450°C\nT2: ≤300°C\nT3: ≤200°C (common for petroleum vapours)\nT4: ≤135°C\nT5: ≤100°C\nT6: ≤85°C\n\nPROTECTION TYPES (IEC 60079 series):\nEx d (Flameproof): enclosure contains explosion, doesn't let flame propagate. Zone 1/2.\nEx e (Increased safety): extra precautions against arcing/sparking. Zone 1/2.\nEx ia/ib (Intrinsic safety): limits energy below ignition. Zone 0/1/2 (ia), Zone 1/2 (ib).\nEx p (Pressurised): enclosure pressurised with clean air/inert gas. Zone 1/2.\nEx n (Non-sparking): for Zone 2 only — simplified design to reduce ignition risk.",
      formula:{
